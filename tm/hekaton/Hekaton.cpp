...
void Hekaton::beginTransaction(DataManager *db, vector<Transaction *> *transactions) {
...
void Hekaton::read(DataManager *db, vector<Record *> *reads, vector<Transaction *> *transactions) {
...
void Hekaton::registerCommitDep(int transaction, vector<Transaction *> *transactions) {
...
void Hekaton::write(DataManager *db) {
}


/// EndNormalProcessing - acquire end timestamp, switch state to preparing, call validate
void Hekaton::endNormalProcessing(DataManager *db, vector<Transaction *> *transactions) {
	Transaction *transaction = transactions->at(_id);
...
void Hekaton::validate(vector<Transaction *> *transactions) {
	bool valid = false;
...
void Hekaton::abort(vector<Transaction *> *transactions) {
	Transaction *transaction = transactions->at(_id);
...
void Hekaton::abortCommitDep(vector<Transaction *> *transactions) {
	Transaction *transaction = transactions->at(_id);
...
void Hekaton::commit(vector<Transaction *> *transactions) {
	Transaction *transaction = transactions->at(_id);
...
void Hekaton::committedCommitDep(vector<Transaction *> *transactions) {
	Transaction *transaction = transactions->at(_id);
	for (vector<int>::iterator it = transaction->getCommitDepSet()->begin() ; it != transaction->getCommitDepSet()->end(); ++it) {
